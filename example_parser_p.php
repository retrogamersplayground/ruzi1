...
if( isset($_POST['n']) && isset($_POST['e']) && isset($_POST['sa']) && isset($_POST['c']) && isset($_POST['st']) && isset($_POST['z']) && isset($_POST['m']) && isset($_POST['mc']) ){
	...
	$message = htmlentities('<b>Businsess Name:</b> '.$n.' <br><b>Email:</b> '.$e.' <br><b>Street Address:</b> '.$sa.' <br><b>City:</b> '.$c.' <br><b>State:</b> '.$st.' <br><b>Zip Code:</b> '.$z.' <br><b>Mobile Number:</b> '.$m.' <br><b>Mobile Carrier:</b> '.$mc.'');
